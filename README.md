...
3. 若缺失，从 ChatHistory 提取 type/targetId 构造带参数的 qchat 标签
...
### v1.1.0
- 分类从「Alife 官方/生活环境」改为「用户自制/输出标签」
- 后处理补标现在会从 ChatHistory 提取 type/targetId 参数
- 修复缺少 type 信息导致消息发不出去的问题
- 贡献者：银月 (QQ: 2141951927) — type/targetId 提取改进
...
感谢银月——贡献了 type/targetId 提取的改进代码，让插件能正确识别 QQ 群/私聊场景。

...
原作者 **银月** (QQ: 2141951927) — 插件的原始设计者和主要实现者
维护者 **爱奈丽** — 在银月代码基础上维护、发布至插件市场

感谢 [Alife](https://github.com/BDFFZI/Alife) 和它的创造者 [半点星光](https://github.com/BDFFZI)
感谢 [初心](https://github.com/ChuXinCode) 群友的参考原型
感谢 [周武 (znq19)](https://github.com/znq19) 的指导和bug反馈
